        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                ...
                new Customer
                {
                    ...
                    Password = "123@ADC",
                    PhoneNumber = "234567",
                    DateOfBirth = new DateTime(1988, 8, 15, 0, 0, 0,  DateTimeKind.Utc),
                    IsActive = true,
            ...
            modelBuilder.Entity<Order>().HasData(
                ...
                {
                    Id = 1,
                    OrderDate = new DateTime(2025, 02, 06, 0, 0, 0, DateTimeKind.Utc),
                    CustomerId = 1,
                    ShippingAddressId = 1,
                    Status = "Processing",
                ...
                {
                    Id = 2,
                    OrderDate = new DateTime(2025, 02, 05, 0, 0, 0, DateTimeKind.Utc),
                    CustomerId = 1,
                    ShippingAddressId = 1,
                    Status = "Processing",
            ...
            modelBuilder.Entity<TrackingDetail>().HasData(
                ...
                new TrackingDetail { Id = 2, OrderId = 2, Carrier = "FedEx", EstimatedDeliveryDate = new DateTime(1988, 02, 15, 0, 0, 0, DateTimeKind.Utc), TrackingNumber = "123789456" }
            );
        }
