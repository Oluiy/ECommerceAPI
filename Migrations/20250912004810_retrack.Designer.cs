...
namespace EcommerceAPI.Migrations
{
    ...
    [Migration("20250912004810_retrack")]
    partial class retrack
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            DateOfBirth = new DateTime(1988, 8, 15, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("ECommerceAPI.Models.MembershipTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DeliveryCharge = 0m,
                            OrderDate = new DateTime(2025, 2, 6, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("ECommerceAPI.Models.TrackingDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Carrier = "FedEx",
                            EstimatedDeliveryDate = new DateTime(2025, 2, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            OrderId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Carrier = "FedEx",
                            EstimatedDeliveryDate = new DateTime(1988, 2, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            OrderId = 2,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Customer", b =>
                {
                    b.HasOne("ECommerceAPI.Models.MembershipTier", "MembershipTier")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Order", b =>
                {
                    ...
                    b.HasOne("ECommerceAPI.Models.Address", "ShippingAddres")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerceAPI.Models.TrackingDetail", b =>
                {
                    b.HasOne("ECommerceAPI.Models.Order", "Order")
                        ...
                        .HasForeignKey("ECommerceAPI.Models.TrackingDetail", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
